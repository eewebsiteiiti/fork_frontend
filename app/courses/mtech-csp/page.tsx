...
function getCourses(): Course[] {
  try {
    return db.prepare('SELECT * FROM mtech_csp_courses ORDER BY semester, code').all() as Course[];
  } catch {
    return [];
  }
}

export default function MTechCSPCoursesPage() {
  ...
  return (
    <PageLayout
      title="M. Tech. Core Courses (CSP)"
      subtitle="Core curriculum for M. Tech. in Communications and Signal Processing"

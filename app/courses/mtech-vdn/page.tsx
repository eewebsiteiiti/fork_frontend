...
function getCourses(): Course[] {
  try {
    return db.prepare('SELECT * FROM mtech_vdn_courses ORDER BY semester, code').all() as Course[];
  } catch {
    return [];
  }
}

export default function MTechVDNCoursesPage() {
  ...
  return (
    <PageLayout
      title="M. Tech. Core Courses (VDN)"
      subtitle="Core curriculum for M. Tech. in VLSI Design and Nanoelectronics"

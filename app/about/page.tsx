...
export default function AboutPage() {
  ...
  return (
    <PageLayout
      title="ABOUT US"
      subtitle="From starting out as one of the founding departments of the Institute from 2009, the Department of Electrical Engineering at IIT Indore has grown in leaps and bounds. Apart from 24 faculty members and 8 support staff, the EE Department currently has around 330 UG students, 50 PG and about 120 Doctoral students actively enrolled. The department is ranked highly at the national level, with 1500+ publications having a combined citation count of 60000+ citations. In the short span of 15 years, since inception, the department has successfully executed 100+ research projects sponsored by various national and international agencies with a combined funding to the tune of INR 32 Crores. Furthermore, around 26 patents have been granted and several more have been filed. The department has proudly graduated a total of around 1200 students to date and hopes to continue its journey onward in the pursuit of excellence."

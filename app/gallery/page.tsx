...
const galleryCategories = {
  department: {
    title: 'Department',
    images: [
      '/images/gallery/department/1.jpg',
      '/images/gallery/department/2.jpg',
      '/images/gallery/department/13.jpg',
  ...
  students: {
    ...
    images: [
      ...
      '/images/gallery/batches/mtech25.jpg',
      '/images/gallery/batches/phd-23.jpg',
      '/images/gallery/batches/phd23.jpg',
    ],
  },
  events: {
    title: 'Events',
  ...
  fauna: {
    ...
    images: [
      ...
      '/images/fauna/iiti-leopard-4.jpg',
      '/images/fauna/iiti-leopard-drb.jpg',
